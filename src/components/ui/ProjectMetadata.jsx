...
const MetaLabel = ({ children }) => (
  <div className="meta-label mb-1">{children}</div>
);
    ...
    <div className="w-full mb-6 md:mb-8 py-3 md:py-4">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-y-4 md:gap-y-6 gap-x-4">
        <div>
          ...
          <div className="text-neutral-900 text-sm md:text-base font-semibold leading-tight">{role}</div>
        </div>

        <div>
          <MetaLabel>Timeline</MetaLabel>
          <div className="text-neutral-900 text-sm md:text-base font-semibold leading-tight">{timeline}</div>
        </div>
        ...
        <div>
          ...
          <div className="text-neutral-900 text-sm md:text-base font-semibold leading-tight">
